...
class EditConcertTest extends TestCase
{
    ...
    function promoters_can_edit_their_own_unpublished_concerts()
    {
        ...
        $this->assertFalse($concert->isPublished());
        $response = $this->actingAs($user)->from('/backstage/concerts')->patch("/backstage/concerts/{$concert->id}", [
            'title' => 'New title',
            'subtitle' => 'New subtitle',
            'additional_information' => 'New additional information',
            'date' => '2018-12-12',
    ...
    function promoters_cannot_edit_other_unpublished_concerts()
    {
        ...
        $this->assertFalse($concert->isPublished());
        $response = $this->actingAs($user)->from('/backstage/concerts')->patch("/backstage/concerts/{$concert->id}", $this->validParams());
    ...
    function guests_cannot_edit_concerts()
    {
        ...
        $this->assertFalse($concert->isPublished());
        $response = $this->from('/backstage/concerts')->patch("/backstage/concerts/{$concert->id}", [
            'title' => 'New title',
            'subtitle' => 'New subtitle',
            'additional_information' => 'New additional information',
            'date' => '2018-12-12',
